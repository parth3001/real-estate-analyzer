...
const PricingPage: React.FC = () => {
  ...
  const tiers = [
    ...
    },
    {
      ...
      lines: [
        ...
        'Save to your Deal Workspace · PDF export',
  ...
  const valueProps = [
    ...
    { label: 'Deal Workspace', detail: 'Every saved deal opens in its own Deal Workspace — score, audit trail, projections, scenarios, all on one surface. Survives license expiry as read-only.' },
