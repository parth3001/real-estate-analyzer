...
|---|---|---|---|
| 1 | Q&A migration scope (W3) | **Wrap first; refactor wave 2 if needed** | Doesn't impact weeks 1-2 (W3 starts week 3+) |
...
| 6 | Wave 1 exit criteria | **All 12 wave 1 workstreams ship + ≥95% calibration pass (zero tolerance per evals §3.2) + ≥85% cache hit rate + ≥1000 substrate events + chat handles end-to-end on /app** | Locks weeks 1-2 exit signal toward "first event written, first chat turn end-to-end" |
